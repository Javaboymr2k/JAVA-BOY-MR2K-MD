 ...
 * @author : Malvin King <https://github.com/javaboymr2k>
...
const ownerNumber = ['260967838144']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("JAVA-BOY-MR2K-MD~", '');
...
console.log("CONNECTING JAVA-BOY-MR2K-MD 🧬...");
...
console.log('JAVA-BOY-MR2K-MD CONNECTED TO WHATSAPP ENJOY ✅')
...
*https://https://whatsapp.com/channel/0029Vb6ULcfEawduL2qfWE37
...
if(senderNumber.includes("260967838144")){
if(isReact) return
m.react("🦋")
   }
...
//==========================public react===============//
// Auto React 
if (!isReact && senderNumber !== 260967838144) {
...
app.get("/", (req, res) => {
res.send("HEY, JAVA-BOY-MR2K-MD STARTED ✅");
});

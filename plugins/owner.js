...
*⚡Owner name -: MR2K CYBER TECH*
*⚡Number* -: +260967838144

 ⚡️◦ https://whatsapp.com/channel/0029Vb6ULcfEawduL2qfWE37
> *Powered by JAVA-BOY-MR2K-MD🇿🇲*
`;
...
👨‍💻◦https://github.com/Javaboymr2k/JAVA-BOY-MR2K-MD


*📍ℙ𝕃𝔼𝔸𝕊𝔼 𝔽𝕆𝕃𝕃𝕆𝕎 𝕄𝕐 𝕎ℍ𝔸𝕋𝕊𝔸ℙℙ ℂℍ𝔸ℕℕ𝔼𝕃 ❤️‍🔥👇*

👨‍💻◦ https://whatsapp.com/channel/0029Vb6ULcfEawduL2qfWE37
> *Powered by MR2K CYBER TECH*
`;
await conn.sendMessage(from,{image:{url: config.MENU_IMG},caption:dec},{quoted:mek});
...
├ 👨‍💻 *Owners:-* MR2K CYBER TECH
├ 🧬 *Version:-* 3.0.0
└───────────────────────

> *𝘗𝘖𝘞𝘌𝘙𝘌𝘋 𝘣𝘺 JAVA-BOY-MR2K-MD🇿🇲*
`;
return reply(`${status}`)
